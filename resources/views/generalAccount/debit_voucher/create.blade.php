            ...
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        @can('credit-voucher-list')
                        <div class="panel-heading-btn pull-right">
                            <a class="btn btn-success btn-sm" href='{{route('debit-vouchers.index')}}'>
                                Debit Voucher List
                            </a>
                        </div>
                        @endcan
                    ...
                    <div class="panel-body" id="tabArea">
                        <form action="{{route('debit-vouchers.store')}}"  method="post">
                            @csrf
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label>Paid to : </label>
                                    <input type="text" value="{{old('party_name')}}" name="party_name" class="form-control"
                                           id="party_name"
                                           placeholder="Client / Vendor Name" required autocomplete="off">
                                    <input type="hidden" value="{{old('party_id')}}" name="party_id" id="party_id">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="ref_id"> Reference ID :</label>
                                    <input type="text" value="{{old('ref_id')}}" name="ref_id" class="form-control"
                                    autocomplete="off">
                                    <br>
                                </div>
                                <div class="form-group col-md-4">
                                            ...
                                            <tr class="record-row">
                                                <td>
                                                    <div class="col-md-12 no-padding">
                                                        <input value="{{old('chart_of_account')[$i]}}" type="text"
                                                               ...
                                                               small-box chart_of_accounts" autocomplete="off" required>
                                                ...
                                                <td>
                                                    <input value="{{old('payable_amount')[$i]}}" type="number"
                                                           ...
                                                           class="form-control small-box payable_amounts" required>
                                                </td>
                                                <td>
                            ...
                            <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" name="cheque_no"
                                                       autocomplete="off" placeholder="Cheque No.">
                                            </div>
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group aside_system">
                                        ...
                                        <div class="input-group col-md-8">
                                            ...
                                            <input value="" class="form-control" style="text-align: right"
                                                   name="totalPayable"  id="totalPayable" tabindex="-1"
                                    ...
                                    <div class="form-group aside_system">
                                        ...
                                        <div class="input-group col-md-8">
                                            <div class="input-group-addon currency">৳</div>
                                            <input value="0" type="number" style="text-align: right" min="0"
                                                   step="any"  class="form-control" tabindex="-1" name="totalPaid"
                                                   id="totalPaid" placeholder="Paid Amount" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group aside_system">
                                        ...
                                        <div class="input-group col-md-8">
                                            <div class="input-group-addon currency">৳</div>
                                            <input value="" type="number" style="text-align: right" min="0"
                                                   step="any"  class="form-control amountDue" tabindex="-1"
                                ...
                                <div class="col-md-6 col-lg-offset-3">
                                    <label>&nbsp;</label>
                                    <button type="submit" class="btn btn-success col-sm-12">Submit Payment</button>
                                </div>
                            </div>
                        </form>
                    </div>
