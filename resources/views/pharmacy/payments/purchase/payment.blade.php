...
{{--                        <h4 class="panel-title"> {{ $voucher->isDebit()  ? "Debit Voucher Payment" : 'Credit Voucher Payment'}} </h4>--}}
                    ...
                    <div class="panel-body" id="tabArea">
                        <form method="post" action="{{ action('Pharmacy\InventoryPurchasePaymentController@store', $invoice)
                         }}">
                            @csrf
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    <label>Paid to : </label>
                                    <input type="text" class="form-control" value="{{$invoice->manufacturer->name}}" readonly>
                                </div>
                                <div class="form-group col-md-4">
