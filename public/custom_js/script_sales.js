...
$(document).on('change keyup keypress blur','.changesNo',function(){
    ...
    $('.quantity').each(function(){
    	...
    	var uPrice = parseFloat($('#unitPriceForeign_'+id).val());

        bdtPrice+=(qty*price);
        usdPrice+=(qty*uPrice);
	});
   $('#total_foreign_amount').val(usdPrice);
